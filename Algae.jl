...
# ╔═╡ 292b088c-0af8-4409-90b9-ff18a1452965
...
md"Het *Great Barrier Reef*, gelegen aan de kust van Queensland in Australië, is het grootste koraalrif ter wereld. Het is een ecosysteem waarvan de ecosysteemdiensten een vitale functie uitoefenen voor veel plaatselijke gemeenschappen. In 1997 werd duidelijk dat klimaatverandering een negatieve invloed had op de werking van het rif, dit jaar werd dan ook uitgeroepen tot jaar van het rif (UNSW Australia iGEM 2020, 2020).
...
end k₁ k₂ k₃ k₄ k₅ k₆ k₇ k₈ k₉ k₁₀ k₁₁

# ╔═╡ f5a6c3a9-b0af-44dd-ad94-a5dad691ec04
md"## Simulatie van het model"

# ╔═╡ fd830684-54d7-42c9-aa8d-2989481715bf
md"Beide systemen werden omgezet naar volgende differentiaalvergelijkingen:"
...
# ╔═╡ bdbe3d81-e1a3-41d1-8c9a-90b476e9689a
md"k₁ tot en met k₄, k₁₁ en k₁₂ zijn gebaseerd op onderzoek van Proctor et al. (2005). k₆ werd berekend op basis van informatie verkregen van het onderzoek van ÅSlund et al. (1999). k₆, k₈ en k₉ komen uit het model van UNSW Australia iGEM 2020 (2020). Voor k₇ was er geen experimentele waarde, dit is de vertraging in het systeem door de werking van OxyR, deze waarde is volgens de verwachting geoptimaliseerd. Tot slot is er een gekozen waarde voor k₅ gebruikt om ervoor te zorgen dat het natuurlijk systeem in evenwicht bleef.
...
# ╔═╡ 05a9846e-a597-4422-aefb-b0803ece58bb
...
# ╔═╡ 47ecbc76-53b2-40e2-a394-4d72f2c03ded
md"Hiervoor werd eerst een lognormale verdeling opgesteld rond k₅."

# ╔═╡ 18c8e084-49b1-46cb-aac5-2294f1a1d070
md" Uit deze verdeling kan onderstaande Monte Carlo functie willekeurige waarden nemen om zo het functieverloop van het model te bepalen voor verschillende waarden van k₅. Deze functie werd tweemaal toegepast, zowel voor het natuurlijke systeem als voor het genetische circuit."

# ╔═╡ e5d5035c-ac54-4011-8276-776349a9045e
function monte_carlo(simulator::Function, Pθ::Sampleable; n=1000)
	θs = [rand(Pθ) for i in 1:n]
	xs = [simulator(1,0.00001,10, 0, θ, 20, 0.1, 0.0002, 20,  0.1,  8.2*10^-9,  6*10^-7) for θ in θs]
	return xs, θs
end;

# ╔═╡ 384a6b56-39d5-4704-9cc5-7907755a1792
function monte_carloNat(simulator::Function, Pθ::Sampleable; n=1000)
	θs = [rand(Pθ) for i in 1:n]
	xs = [simulator(1,0.00001,10,0, θ, 6*10^-7) for θ in θs]
	return xs, θs
end;

# ╔═╡ 64e8f875-0c65-440b-bfdb-b945bc02a86a
...
# ╔═╡ 5eef660d-7fdf-478c-84d5-adb5e69b2e34
tsteps = 0:0.5:100

# ╔═╡ 3e49c0ff-62b0-4fae-8830-88cdda2874de
...
# ╔═╡ df739000-366c-4cf4-ab14-f25e9cd45900
md"# Bronnen"

# ╔═╡ 80dfe860-1156-44d9-ba94-4a655b123f81
md"Fedyaeva, A. V., Stepanov, A. V., Lyubushkina, I. V., Pobezhimova, T. P., en Rikhvanov, E. G. (2014). Heat shock induces production of reactive oxygen species and increases inner mitochondrial membrane potential in winter wheat cells. *Biochemistry (Moscow)*, 79(11):1202–1210.

Lesser, M. (1997). Oxidative stress causes coral bleaching during exposure to elevated temperatures. *Coral Reefs*, 16(3):187–192.

NOAA (2021). What is coral bleaching? [https://oceanservice.noaa.gov/facts/
coral_bleach.html](https://oceanservice.noaa.gov/facts/
coral_bleach.html) [Geraadpleegd: 13/05/2022].

Proctor, C. J., S ̋oti, C., Boys, R. J., Gillespie, C. S., Shanley, D. P., Wilkinson, D. J., en Kirkwood, T. B. (2005). Modelling the actions of chaperones and their role in ageing. *Mechanisms of Ageing and Development*, 126(1):119–131.

UNSW Australia iGEM 2020 (2020). Mathematical modelling. [https://2020.igem.
org/Team:UNSW_Australia/Model/mathematical](https://2020.igem.
org/Team:UNSW_Australia/Model/mathematical) [Geraadpleegd: 10/05/2022].

UNSW Australia iGEM 2021 (2021). Modelling: Kinetic modelling of the
glutathione system. [https://2021.igem.org/Team:UNSWAustralia/Model/
GlutathioneSystem](https://2021.igem.org/Team:UNSWAustralia/Model/
GlutathioneSystem) [Geraadpleegd: 10/05/2022].

Åslund, F., Zheng, M., Beckwith, J., en Storz, G. (1999). Regulation of the oxyr
transcription factor by hydrogen peroxide and the cellular thiol—disulfide status.
*Proceedings of the National Academy of Sciences*, 96(11):6161–6165."

# ╔═╡ 1b5f357c-64c9-4e77-8772-3dea7eb7bcce
md"# Extra code"

# ╔═╡ c7b8b233-929c-42c3-96ae-c14dfbb55eda
md"### Simulatie van het model"
...
md"### Monte Carlo analyse"

# ╔═╡ 065d49eb-255c-43da-8fb8-b3f9e92f5cdd
md"k₅_star is de startwaarde van k₅ voor de Monte Carlo analyse." 

# ╔═╡ 47a4c424-d8e7-404f-a9c4-e850292ea26a
k₅_star = 1.65*10^(-9)

# ╔═╡ aa0dc5d6-f540-4a56-a128-38440490f4dc
Pk₅ = LogNormal(log(k₅_star), 0.25)

# ╔═╡ 50be95c7-e978-4a58-9def-19b5ce88b8e3
...
# ╔═╡ baad4976-f155-40bd-b015-e2935a783525
begin
	myblue = "#304da5"
	mygreen = "#2a9d8f"
	myyellow = "#e9c46a"
...
function plotMC(throws; kwargs...)
	...
	plot!(p, tsteps, mean(throws), label="simulatiegemiddelde", color=myred, lw=2)
	return p
end

# ╔═╡ 7ab95d43-7810-4896-8976-31a1fe779154
md"Data voor de grafieken bij Monte Carlo analyse:"

# ╔═╡ b38f99d2-1de1-445e-8864-626615c7e0f6
...
git-tree-sha1 = "9abf572e3b43a4290ed2ab57f2f281c6f44de8ee"
