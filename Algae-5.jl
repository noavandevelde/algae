...
De factor uit de tabel is de verhouding tussen een gekozen temperatuur en de referentietemperatuur, hier 25°C. Aangezien verhoogde temperaturen een sterke invloed op ROS productie hebben, is de factor in rekening gebracht bij de ROS productie reactie (k₅)(Fedyaeva et al., 2014). Analoog aan het iGEM-project verwaarlozen we het effect van de temperatuur op de andere k-waarden."
...
md" Uit deze verdeling kan kan onderstaande Monte Carlo functie willekeurige waarden nemen om zo het functieverloop van het model te bepalen voor verschillende waarden van k₅. Deze functie werd tweemaal toegepast, zowel voor het natuurlijke systeem als voor het genetische circuit."
